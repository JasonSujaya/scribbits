...
export const englishMessages = {
  ...
  'splash.tagline': 'DRAW IT. WATCH IT FIGHT.',
  'splash.hook.drawnByYou': 'DRAWN BY YOU',
  'splash.hook.doodle': 'YOUR DOODLE.',
  'splash.hook.fighter': 'YOUR FIGHTER.',
  'splash.hook.shapeStats': 'SHAPE BECOMES STATS',
  ...
  'splash.error.expand':
    'Scribbits could not open. Tap Enter Arena to try again.',
