...
export const SFX_CATALOG = {
  ...
  'ui.tab': {
    ...
    cooldownMilliseconds: 70,
    maximumVoices: 2,
    tones: [tone(260, 390, 0.09, 0.012, 'triangle')],
  },
  'ui.toggle': {
    samples: ['ui-toggle'],
    volume: 0.28,
  ...
  'claw.search': {
    ...
    maximumVoices: 1,
    tones: [
      tone(95, 135, 0.3, 0.012, 'sawtooth'),
      tone(190, 250, 0.18, 0.008, 'square', 0.08),
    ],
  },
  'claw.descend': {
    ...
    cooldownMilliseconds: 220,
    maximumVoices: 1,
    tones: [tone(180, 72, 0.34, 0.016, 'sawtooth')],
  },
  'claw.grab': {
    ...
    cooldownMilliseconds: 180,
    maximumVoices: 1,
    tones: [tone(420, 130, 0.14, 0.014, 'triangle')],
  },
  'claw.lift': {
    samples: ['ui-scratch'],
    volume: 0.3,
    cooldownMilliseconds: 220,
    maximumVoices: 1,
    tones: [tone(82, 150, 0.34, 0.014, 'sawtooth')],
  },
  'claw.drop': {
    samples: ['impact-wood'],
    volume: 0.4,
    cooldownMilliseconds: 180,
    maximumVoices: 1,
    tones: [tone(210, 58, 0.2, 0.016, 'square')],
  },
  'claw.win': {
    samples: ['ui-confirm-2'],
    volume: 0.4,
    cooldownMilliseconds: 260,
    maximumVoices: 1,
    tones: [
      tone(330, 440, 0.13, 0.012, 'triangle'),
      tone(440, 660, 0.18, 0.014, 'triangle', 0.1),
    ],
  },
  'battle.fight': {
    samples: ['paper-open'],
