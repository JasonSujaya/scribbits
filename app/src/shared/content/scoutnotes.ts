...
> = Object.freeze({
  open: freezeLines([
    ...
    'The Rumble field is copied; one pencil circle is still waiting.',
  ...
  pending: freezeLines([
    'Pick pinned; the Rumble result has not been filed yet.',
  ...
  finalist: freezeLines([
    ...
    'Finalist page filed; the scouting mark matches the Rumble record.',
  ...
  no_clout: freezeLines([
    ...
    'The closed Rumble leaves this scouting circle with a plain stamp.',
